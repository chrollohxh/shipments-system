...
(() => {
  ...
  const baharSheet = (record, kind) => {
    ...
    let itemsFs = '12.5px', thFs = '11.5px', thPad = '2.6mm 2mm', tdH = '8.2mm', tdPad = '2mm', sectionGap = '3mm', boxPad = '3mm', termsMinH = '18mm';
    if (rowCount >= 13) { itemsFs = '7.5px'; thFs = '7px'; thPad = '1.2mm 1mm'; tdH = '4mm'; tdPad = '0.7mm'; sectionGap = '1.5mm'; boxPad = '2mm'; termsMinH = '11mm'; }
    else if (rowCount >= 10) { itemsFs = '9px'; thFs = '8.5px'; thPad = '1.6mm 1.3mm'; tdH = '5mm'; tdPad = '1mm'; sectionGap = '2mm'; boxPad = '2.4mm'; termsMinH = '14mm'; }
    else if (rowCount >= 7) { itemsFs = '10.5px'; thFs = '9.5px'; thPad = '2mm 1.6mm'; tdH = '6mm'; tdPad = '1.5mm'; sectionGap = '2.5mm'; boxPad = '2.6mm'; termsMinH = '16mm'; }
    ...
    const body = `
      ...
      <div class="bahar-shipment-sheet" style="--red:${safe(accent)}">
        ...
        <main>
          ...
          <section class="totals"><div><b>TOTAL PACKAGES</b><strong>${safe(record.totalQty || record.qty || '')} ${safe(record.qtyUnit || '')}</strong></div><div><b>TOTAL AMOUNT</b><strong>${safe(toAedText(record.totalAmount, record.bsgtAutoAed !== false) || rows[0]?.amount || '')}</strong></div></section>
