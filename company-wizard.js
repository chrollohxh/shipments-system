(() => {
  ...
  function renderBaharSimpleSettings() {
    ...
    one('.bs-color-reset').addEventListener('click', () => {
      ...
      // current accent color, value-type fields go back to the default dark ink.
      ...
      simple.querySelectorAll('.bs-color').forEach(el => { el.value = labelFields.has(el.dataset.key) ? resolvedAccent : '#17202b'; });
