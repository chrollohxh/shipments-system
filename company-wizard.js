  ...
  function renderBaharSimpleSettings() {
    ...
    simple.innerHTML = `
      ...
      <div class="bs-workspace"><div class="bs-card">
        ...
        <div class="section-title" style="margin-top:20px">ألوان الأقسام الأخرى (المرسل إليه، الشروط، البنك)</div>
        <div class="bs-grid">
          ${colorField('sectionBgColor', 'لون خلفية هذه الأقسام', settings.sectionBgColor, '#ffffff')}
          ${colorField('sectionBorderColor', 'لون حدود هذه الأقسام', settings.sectionBorderColor, resolvedAccent)}
        </div>
    ...
    one('.bs-color-reset').addEventListener('click', () => {
      ...
      const tableDefaults = { productHeaderBgColor: lightenHex(resolvedAccent, 0.14), productValueBgColor: '#ffffff', tableBorderColor: resolvedAccent, sectionBgColor: '#ffffff', sectionBorderColor: resolvedAccent };
