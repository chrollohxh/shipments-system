...
(() => {
  ...
  const baharSheet = (record, kind) => {
    ...
    let itemsFs = '13.5px', thFs = '12.5px', thPad = '2.8mm 2mm', tdH = '8.6mm', tdPad = '2mm', sectionGap = '3mm', boxPad = '3mm', termsMinH = '18mm';
    if (rowCount >= 13) { itemsFs = '8.5px'; thFs = '8px'; thPad = '1.3mm 1mm'; tdH = '4.4mm'; tdPad = '0.7mm'; sectionGap = '1.5mm'; boxPad = '2mm'; termsMinH = '11mm'; }
    else if (rowCount >= 10) { itemsFs = '10px'; thFs = '9.5px'; thPad = '1.7mm 1.3mm'; tdH = '5.4mm'; tdPad = '1mm'; sectionGap = '2mm'; boxPad = '2.4mm'; termsMinH = '14mm'; }
    else if (rowCount >= 7) { itemsFs = '11.5px'; thFs = '10.5px'; thPad = '2.1mm 1.6mm'; tdH = '6.4mm'; tdPad = '1.5mm'; sectionGap = '2.5mm'; boxPad = '2.6mm'; termsMinH = '16mm'; }
